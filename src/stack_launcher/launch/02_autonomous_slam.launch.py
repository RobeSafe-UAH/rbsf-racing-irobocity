"""
02_autonomous_slam — Autonomous wall-following with a PID controller + SLAM mapping.
...
Quick start:
    ros2 launch stack_launcher 02_autonomous_slam.launch.py                   # sim, right wall
    ros2 launch stack_launcher 02_autonomous_slam.launch.py mode:=real        # physical car
    ros2 launch stack_launcher 02_autonomous_slam.launch.py side:=left        # left wall
